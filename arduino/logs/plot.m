...
plot \
     ...
     "z.log" using 10:16		title "TLT"	pointinterval -12	pointsize 1	lw 2	pointtype "T",	\
     "z.log" using 10:18		title "TLTt"	pointinterval -6	pointsize 1	lw 2	pointtype "t",	

#     "z.log" using 10:($22/10)		title "COUT/10"	pointinterval -12	pointsize 1	lw 2	pointtype "C",
#     "z.log" using 10:($16/10)		title "SPDt/10"	pointinterval -12	pointsize 1	lw 2	pointtype "s"
