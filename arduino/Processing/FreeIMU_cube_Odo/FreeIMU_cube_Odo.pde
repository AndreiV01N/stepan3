...
void serialEvent(Serial p) {
  ...
  if (inputStringArr.length >= 17) {
    q[0] = float(inputStringArr[0]);
    q[1] = float(inputStringArr[1]);
    q[2] = float(inputStringArr[2]);
    q[3] = float(inputStringArr[3]);

    acc[0] = float(inputStringArr[4]);
    acc[1] = float(inputStringArr[5]);
    acc[2] = float(inputStringArr[6]);

    gyro[0] = float(inputStringArr[7]);
    gyro[1] = float(inputStringArr[8]);
    gyro[2] = float(inputStringArr[9]);

    magn[0] = float(inputStringArr[10]);
    magn[1] = float(inputStringArr[11]);
    magn[2] = float(inputStringArr[12]);

    temp = float(inputStringArr[13]);
    press = float(inputStringArr[14]);
    dt = float(inputStringArr[15]);
    heading = float(inputStringArr[16]);
    altitude = float(inputStringArr[17]);
...
//==============================================================
//SMA filter
// Use the next value and calculate the moving average
